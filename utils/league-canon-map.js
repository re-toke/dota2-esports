...
// 赛事展示名规范映射（精确归一匹配）。数据来自 curation-shared.json，由
// scripts/sync-canon-map.js 从 utils/curation.js 的 CURATED_EVENTS 生成。
//
// G4 单一数据源：小程序与云函数 aggregation 共用同一份生成产物
// （cloudfunctions/aggregation/league-canon-map.js + curation-shared.json），
...
const DATA = require('./curation-shared.json');
